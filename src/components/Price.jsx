const Price = () => {
  return (
    <div>
      <section className="py-20  text-gray-800 p-2 ">
        <div className="container px-4 mx-auto">
          <div className="max-w-2xl mx-auto mb-16 text-center">
            <span className="font-bold tracking-wider uppercase text-violet-600">
              Pricing
            </span>
            <h2 className="text-2xl  sm:text-4xl dark:text-info font-banner">
              Choose a plan 
            </h2>
          </div>
          <div className="flex flex-wrap items-stretch -mx-4">
            <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0 ">
              <div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 bg-gray-50">
                ...
                <p className="mt-3 leading-relaxed text-gray-600">
                  Let{`'s`} start free to connect with us.
                </p>
                <ul className="flex-1 mb-6 text-gray-600">
                  ...
                  <li className="flex mb-2 space-x-2">
                    ...
                    <span> Display on the top page</span>
                  </li>
                  <li className="flex mb-2 space-x-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span className="line-through">  Unlimited Builds</span>
                  </li>
                  <li className="flex mb-2 space-x-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span  className="line-through"> post displayed for 30 days</span>
                  </li>
                  <li className="flex mb-2 space-x-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span  className="line-through">  Premium Support 24/7</span>
                  </li>
                </ul>
                <button
                  type="button"
            ...
            <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
              <div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 bg-violet-600 text-gray-50">
                ...
                <p className="leading-relaxed">
                 The most popular package we have.
                </p>
            ...
            <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
              <div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 bg-gray-50">
                <div className="space-y-2">
                  <h4 className="text-2xl font-bold">Enterprice</h4>
                  <span className="text-6xl font-bold">
                    $72
                    <span className="text-sm tracking-wide">/month</span>
                  </span>
                ...
                <p className="leading-relaxed text-gray-600">
                  The best service all we provide.
                </p>
                ...
                <li className="flex mb-2 space-x-2">
                  ...
                  <li className="flex mb-2 space-x-2">
                    ...
                    <span> post displayed for 30 days</span>
                  </li>
                  <li className="flex mb-2 space-x-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
